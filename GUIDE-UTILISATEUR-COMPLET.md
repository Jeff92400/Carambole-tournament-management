...
> - **🎮 Directeur de Jeu (DdJ)** (23/04/2026) : Nouvelle section du guide dédiée au module DdJ. Écran d'accueil disponible dès aujourd'hui (compétitions du jour avec statut). Workflow complet 6 étapes (pointage → export E2i) prévu pour la saison 2026-27. Module activable par CDB. Voir section « Compétitions > Directeur de Jeu ».
