...
// V 2.0.687 — POST /constraints/from-natural-language retired.
// The AI rule-translation feature was removed; rules are configured
// through the simplified UI instead.
router.post('/constraints/from-natural-language', authenticateToken, requireCalendarGenerator, requireAdmin, (req, res) => {
